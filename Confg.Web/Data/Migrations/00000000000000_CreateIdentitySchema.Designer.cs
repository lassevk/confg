...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Confg.Web.Data.ApplicationUser", b =>
            {
            ...
            {
                b.Property<byte[]>("CredentialId").HasMaxLength(1024).HasColumnType("BLOB");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
            {
                b.HasOne("Confg.Web.Data.ApplicationUser", null).WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired();
            });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserPasskey<string>", b =>
            {
                ...
                {
                    b1.Property<byte[]>("IdentityUserPasskeyCredentialId").HasColumnType("BLOB");

                    b1.Property<byte[]>("AttestationObject").IsRequired().HasColumnType("BLOB");

                    b1.Property<byte[]>("ClientDataJson").IsRequired().HasColumnType("BLOB");

                    b1.Property<DateTimeOffset>("CreatedAt").HasColumnType("TEXT");

                    b1.Property<bool>("IsBackedUp").HasColumnType("INTEGER");

                    b1.Property<bool>("IsBackupEligible").HasColumnType("INTEGER");

                    b1.Property<bool>("IsUserVerified").HasColumnType("INTEGER");

                    b1.Property<string>("Name").HasColumnType("TEXT");

                    b1.Property<byte[]>("PublicKey").IsRequired().HasColumnType("BLOB");

                    b1.Property<uint>("SignCount").HasColumnType("INTEGER");
